...
\end{lstlisting}
It first checks if the from-city is in the hashmap. If not, it returns and will not print any associated cities. If found, it will iterate through all the elements in the
